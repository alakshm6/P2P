...
class fileReader(threading.Thread):
    def __init__(self, cmdInput, cSock, receiver):
        ...
        self.file = r'C:\Users\ashwin\workspace\P2P\src\rfc105.pdf' #cmdInput[2]                #FILE TO TRANSMIT
    ...
    def rdt_send(self):
        fileHandle = open(r'C:\Users\ashwin\workspace\P2P\src\rfc105.pdf','rb')
        currSeq = 0
        global lastSent
        global acked
        sendMsg = ''
...
class receiver(threading.Thread):
    def __init__(self, cmdInput, cSock):        
        ...
        self.file = "rfc105.pdf" #cmdInput[2]
    ...
    def parseMsg(self, msg):
        sequenceNum = struct.unpack('=I', msg[0:4])            #Sequence Number Acked by the serverAshwin
